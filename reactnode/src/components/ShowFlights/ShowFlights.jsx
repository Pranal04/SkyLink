...
const ShowFlights = () => {
    ...
    const handleSearch = () => {
        navigate(`/showFlightsReturn?from=${from}&to=${to}&class=${travelClass}`, { state: { outboundPrice: Number(selectedFlight.price) } });
      };
        ...
        <div>
            ...
            {selectedFlight && (
                ...
                <div>
                    ...
                    <p className="text-xl font-semibold">₹{selectedFlight.price}</p>
